...
const Signin: React.FC = () => {
    ...
    const signinHandler = async (event: React.FormEvent) => { // Changed to FormEvent
        ...
        try {
            ...
            if (response.data.user) {
                ...
                toast.update(loadingToast, {
                    render: response.data.message || "Signed in successfully",
                    type: "success",
                    isLoading: false,
                    autoClose: 3000
                });
                ...
                toast.update(loadingToast, {
                    render: response.data.error || "Error signing in",
                    type: "error",
                    isLoading: false,
                    autoClose: 3000
                });
